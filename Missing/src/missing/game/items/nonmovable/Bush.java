...
/**
 * Represents a Bush. A Bush is only for aesthetics.
 * Subclass of Foliage
 */
public class Bush extends Foliage{
	 ...
	 * @param worldLocation section of world Bush is located
	 * @param tileLocation the tile inside the worldLocation the Bush is located
	 */
