 ...
 * 
 * Updates : 
 * 7/9 - Added tests 1 and 2 for trees
 * 
 */
...
public class SourceTests {
	...
	/**
	 * Creates a player and a tree, then performs the tree's action. Test ensures player has 1 item in pocket after action*/
	@Test
	...
	/**
	 * Creates a player and a tree, then performs the tree's action. Test ensures player has 1 wood in pocket after action*/
	@Test
