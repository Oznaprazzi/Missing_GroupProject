...
public class MerchantTests {
	...
	public void buyTest_1(){
		...
		Merchant merchant = new Merchant(null, null, tileLocation, tileLocation, null, null, MerchantType.GENERAL);
		player.setMoney(2);
		try{
	...
	/**
	 * tries to buy an item the merchant doesn't have, a game exception should be thrown*/
	@Test
	public void buyInvalidTest_1(){
		Player player = new Player(0, "Chris", new Point(1, 1), new Point(0, 1));
		Point worldLocation = new Point(1, 1);
		Point tileLocation = new Point(1, 1);
		Merchant merchant = new Merchant(null, null, tileLocation, tileLocation, null, null, MerchantType.FOOD);
		player.setMoney(2);
	...
	/**
	 * tries to buy an item without enough money, a game exception should be thrown*/
	@Test
	...
	public void sellTest_1(){
		...
		try{
			...
			assertTrue(wood.getAmount() == 2);//amount of that wood object should decrease by 1
	...
	/**
	 * tries to sell an item which isn't in its pocket. A gameException should be thrown*/
	@Test
