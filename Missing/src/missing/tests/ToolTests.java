...
public class ToolTests {
	...
	public void shovelTest_1(){
		...
		boolean pass = true;
		try{
			Tool tool = new Tool(ToolType.SHOVEL, resources, worldLocation, tileLocation);
		}catch(GameException e){
			pass = false;
		}
		assertTrue(pass);
	...
	/**
	 *tries to create a shovel, but has given 1 wood instead of 2, this should throw a game exception*/
	@Test
